package com.example.ralantonio.palette;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgImagen.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.squirtle));

        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.squirtle);
